function [E,V]=mdss(N, NW, varargin)
% Modified by Sebastien Proulx (jsproulx@mgh.harvard.edu, 2023-11-18) to
% allow for missing data (inspired by https://arxiv.org/pdf/2211.16549.pdf).
...
%   traceFlag - a boolean flag indicating if 'trace' was requested
%
